...
import { getDatabase, ref, set, get, update, remove, child } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js";
...
export { database, ref, set, get, update, remove, child };